      ...
      <div class="container">
         ...
         ?>
            <article class="row cart__body">
               ...
               <div class="col-3 cart__body-quantity d-flex">
                  <form action="/decrease/<?=$cart['id']?>" method="post">
                     <input type="submit" value="-" class="cart__body-quantity-minus">
                  </form>
                  <input type="number" min="1" max="999" value="<?=$cart['quantity']?>" class="cart__body-quantity-total">
                  <form action="/increase/<?=$cart['id']?>" method="post">
                  <input type="submit" value="+" class="cart__body-quantity-plus">
                  </form>
               </div>
               <div class="col-3 cart__body-price">
                  <span><?=currency_format($subtotal)?></span>
                  <form action="/deletecart/<?=$cart['id']?>" method="post">
                  <input href="/deletecart/<?=$cart['id']?>" type="submit" value="Xóa" class="btn btn-danger px-4 py-2"></a>
                  </form>
                  <!-- <input href="/deletecart/<?=$cart['id']?>" type="submit" value="xóa"></a> -->
               </div>
            </article>
         <?php    
               $stt++;
         ...
         <?php }else { ?>
            ...
            <article class="row cart__head pc height-cart">
            <div class="col-12 cart__head-name">
            ...
            <div class="row">
               <article class="footer__top-intro col-lg-5 col-md-4 col-sm-6">
                  ...
                  <div class="footer__top-intro-content">
                     <br> ComicBooks là cửa hàng luôn cung cấp truyện tranh cho giới trẻ. Chúng tôi sẽ liên tục cập
                  nhật những cuốn sách hay nhất, mới nhất.<br>
